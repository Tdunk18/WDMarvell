	...
	)
{
	...
	ipv6_works = 0;  //disable ipv6 temporary, pam 2015.01.09
	...
	*/
	...
	if (!time_adjusted &&
		...
		exitcode = 0;
		system("touch /tmp/stime_ok");	//Vincent05302006
		system("touch /tmp/sntp_ok");	//+Wilson05252006
		printf("NTP Server connected successfully!!!\n");	//+Wilson05252006
	}
