...
extern void iscsi_copy_node_attribues (
	iscsi_node_acl_t *dst_acl,
	iscsi_node_acl_t *src_acl)
{
	iscsi_node_attrib_t *dst_a = &dst_acl->node_attrib;
	iscsi_node_attrib_t *src_a = &src_acl->node_attrib;
	...
	u32 dataout_timeout_retries)
{
	...
	TRACE(TRACE_NODEATTRIB, "Set DataOut Timeout Retries to %u for Initiator"
		" Node %s\n", a->dataout_timeout_retries, acl->se_node_acl.initiatorname);
