...
static const struct {
  ...
  { "locallang",        &opt.local_lang,        cmd_string },	// Jacky + 20150401  support multi-language
  ...
  { "remotelang",       &opt.remote_lang,       cmd_string },	// Jacky + 20150401  support multi-language
...
defaults (void)
{
  ...
  opt.remote_lang = NULL;	// Jacky + 20150401  support multi-language
  opt.local_lang = NULL;	// Jacky + 20150401  support multi-language
}

...
# endif
  ...
  xfree_null (opt.remote_lang);	// Jacky + 20150401  support multi-language
  xfree_null (opt.local_lang);	// Jacky + 20150401  support multi-language
