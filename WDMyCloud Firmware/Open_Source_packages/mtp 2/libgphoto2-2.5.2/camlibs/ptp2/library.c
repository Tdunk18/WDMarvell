...
static struct {
	...
	*/
	...
	{"Samsung:EK-GC100",			0x04e8,	0x6866, DEVICE_FLAG_PROPLIST_OVERRIDES_OI},

	{"Samsung:Galaxy models (PTP mode)",    0x04e8, 0x6865, DEVICE_FLAG_UNLOAD_DRIVER|DEVICE_FLAG_LONG_TIMEOUT|DEVICE_FLAG_PROPLIST_OVERRIDES_OI},
};
