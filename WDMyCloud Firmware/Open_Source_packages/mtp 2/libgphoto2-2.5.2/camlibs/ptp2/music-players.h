 ...
 */
 ...
 { "Samsung", 0x04e8, "YP-Z3", 0x5137,
  ...
  { "LG Electronics Inc.", 0x1004, "LG2 Optimus", 0x6225,
      DEVICE_FLAG_BROKEN_MTPGETOBJPROPLIST |
      DEVICE_FLAG_UNLOAD_DRIVER },
  { "LG Electronics Inc.", 0x1004, "LG G2", 0x6248,
      DEVICE_FLAGS_ANDROID_BUGS },
   ...
   * for now.
   */
  // Reported by ?yvind Stegard <stegaro@users.sourceforge.net>
  ...
  { "SonyEricsson", 0x0fce, "W760i", 0x00c6,
      DEVICE_FLAG_BROKEN_MTPGETOBJPROPLIST },
  // Reported by Linus ?kesson <linusakesson@users.sourceforge.net>
