...
#-	xcp libgphoto2_port/usb/.libs/check-mtp-device ${ROOT_FS}/sbin
	...
	xcp packaging/linux-hotplug/usbcam.console ${MODULE_DIR}/crfs/custom/WD/files/
	xcp packaging/linux-hotplug/usbcam.group   ${MODULE_DIR}/crfs/custom/WD/files/
	xcp packaging/linux-hotplug/usbcam.user    ${MODULE_DIR}/crfs/custom/WD/files/
