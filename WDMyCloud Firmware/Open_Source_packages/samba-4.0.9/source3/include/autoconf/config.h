...
#define HAVE_ACL_LIBACL_H 1 /* ALPHA_CUSTOMIZE */
...
#define HAVE_LONGLONG 1 /* ALPHA_CUSTOMIZE */
...
#define HAVE_SYS_ACL_H 1 /* ALPHA_CUSTOMIZE */
...
#define STRING_STATIC_MODULES " pdb_ldapsam pdb_smbpasswd pdb_tdbsam pdb_wbc_sam idmap_ldap idmap_tdb idmap_passdb idmap_nss nss_info_template auth_sam auth_unix auth_winbind auth_wbc auth_domain auth_builtin vfs_default vfs_posixacl"
...
/* Whether setresuid() is available */
#define USE_SETRESUID 1 /* ALPHA_CUSTOMIZE */
...
/* Decl of Static init functions */
#define static_decl_pdb extern NTSTATUS pdb_ldapsam_init(void); extern NTSTATUS pdb_smbpasswd_init(void); extern NTSTATUS pdb_tdbsam_init(void); extern NTSTATUS pdb_wbc_sam_init(void);
...
/* Static init functions */
#define static_init_pdb {  pdb_ldapsam_init();  pdb_smbpasswd_init();  pdb_tdbsam_init();  pdb_wbc_sam_init();}
