...
//royc 20100503 ==========================================================
#ifdef ALPHA_CUSTOMIZE
	if(strncmp(user_info->client.account_name, "admin", strlen("admin")) != 0)
	{
		DEBUG(0, (CIFS_AUTH_FAIL, user_info->client.account_name));
		openlog("SAMBA", 0, 0);
		syslog(LOG_WARNING, CIFS_AUTH_FAIL, user_info->client.account_name);
		closelog();
	}
#endif
//royc end ==========================================================
