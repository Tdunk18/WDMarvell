...
//royc 20110112 sync from syno ===================================
//do not load MACHINE.SID , because
//1. Crash MACHINE.SID cause write to tdb fail, and it will cause smb panic
//2. MACHINE.SID is used before samba 2.2.5 , DS 1.0 used samba 30b3
