...
//royc 20100503 for syslog(), check auth.c, service.c
#ifdef ALPHA_CUSTOMIZE
#define CIFS_CONNECT	"CIFS: [%s] connected to [%s] as user [%s].\n"
#define CIFS_DISCONN	"CIFS: [%s] closed the connection to service [%s].\n"
#define CIFS_AUTH_FAIL	"CIFS: Authentication for user [%s] has FAILED.\n"
#endif
//royc end
