...
#if defined(Sprite) || defined(Aurora)
//ALPHA_CUSTOMIZE, Casper, On intel Platform use "pppd_argv[an++] = pppInterfaceIPs" has error,  fix this issue with strcpy.
		strcpy(pppd_argv[an++], pppInterfaceIPs);
#else		
