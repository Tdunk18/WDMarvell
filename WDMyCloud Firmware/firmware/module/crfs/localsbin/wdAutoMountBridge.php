    ...
    if ($request == 'createShare') {
        if ($argc != 11) {
            ...
            try {
                ...
                $shareManager->create($argv[2], array('description' => $argv[3], 'public_access' => $argv[4],
                                      'media_serving' => $argv[5], 'volume_id' => $argv[6],
                                      'capacity' => $argv[7], 'read_only' => $argv[8],
                                      'usb_handle' => $argv[9], 'file_system_type' => $argv[10],
                                      'dynamic_volume' => 'true', 'remote_access' => 'false',
                                      'username' => 'admin'));
