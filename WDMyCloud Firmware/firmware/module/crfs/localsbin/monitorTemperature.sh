...
## Temperatures
## NOTE: Need to be part of nas_global.ini
...
## State Files
## NB: Need to be part of nas_global.ini
...
act_emergency()
{
    ...
    ## NB: This handles the condition when timer has not expired
    ## ledCtrl.sh LED_EV_DISK_SMART LED_STAT_OK
