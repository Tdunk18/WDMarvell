<?php
	...
	//fish20130903+ for rest api multi-language
	include_once('language.php');
	$codeset = "UTF8";	// warning ! not UTF-8 with dash '-' 
	$language = new Language();
	$languageStr = $language->getLanguage();
	putenv('LANG='.$languageStr.'.'.$codeset); 
	putenv('LANGUAGE='.$languageStr.'.'.$codeset); 
    ...
    $dictionary['maximum_size'] = _("CONTENT_SETTINGS_DIALOG_LABEL_MAXIMUM_SIZE");
    $dictionary['maximum_size_waring'] = _("CONTENT_SETTINGS_DIALOG_STRING_MAXIMUM_SIZE_WARNING");
	...
	$errors = array();
        ...
        */ 
		...
		$errors['alerts_timeout'] = _("LABEL_IGNORING_ALERTS") . ' ' . _("ERROR_TIMEOUT") . " (31022)";
        ...
        $errors['reboot_timeout'] = _("LABEL_REBOOTING_DEVICE") . ' ' . _("ERROR_TIMEOUT") . " (31026)";
        
        $errors['shutdown_unk'] = _("LABEL_SHUTTING_DOWN_DEVICE") . ' ' . _("ERROR_UNKNOWN") . " (31027)";
        $errors['shutdown_timeout'] = _("LABEL_SHUTTING_DOWN_DEVICE") . ' ' . _("ERROR_TIMEOUT") . " (31028)";
        
        $errors['system_notifications_unk'] = _("LABEL_SENDING_TEST_ALERT_EMAIL") . ' ' . _("ERROR_UNKNOWN") . " (31029)";
        $errors['system_notifications_timeout']= _("LABEL_SENDING_TEST_ALERT_EMAIL") . ' ' . _("ERROR_TIMEOUT") . " (31030)";
        
        $errors['ssh_unk'] = _("LABEL_TOGGLING_SSH") . ' ' . _("ERROR_UNKNOWN") . " (31031)";
        $errors['ssh_timeout'] = _("LABEL_TOGGLING_SSH") . ' ' . _("ERROR_TIMEOUT") . " (31032)";
        ...
        */ 
        ...
        $errors['system_updates_timeout'] = _("ERROR_TIMEOUT") . " (31122)";
        
        $errors['system_usage_timeout'] = _("LABEL_GET_USAGE") . ' ' . _("ERROR_TIMEOUT") . " (31123)";
        ...
        */
        ...
        $errors['system_general_settings_timeout'] = _("LABEL_CONFIGURING_SETTINGS_GENERAL") . _("ERROR_TIMEOUT") . " (31177)";
        ...
        $errors['update_status_timeout'] = _("LABEL_GET_FIRMWARE_UPDATE_PROGRESS") . ' '. _("ERROR_TIMEOUT") . " (31181)";
        ...
        $errors['network_lan_configuration_timeout']= _("ERROR_TIMEOUT_IPADDRESS_CHANGED") . " (31208)";
        ...
        */ 
        ...
        $errors['invalid_firmware_file_type'] = _("ERROR_INVALID_FIRMWARE_FILE_SELECTED") . " (31302)";
        ...
        $errors['config_file_timeout'] = _("ERROR_TIMEOUT_IPADDRESS_CHANGED") . " (31320)";
        ...
        $errors['start_selftest_timeout'] = _("LABEL_STARTING_DIAGNOSTIC_TEST") . ' ' . _("ERROR_TIMEOUT") . " (31346)";
        ...
        $errors['get_selftest_timeout'] = _("LABEL_GET_SELFTEST_PROGRESS") . ' ' . _("ERROR_TIMEOUT") . " (31356)";
        ...
        $errors['cancel_selftest_timeout'] = _("LABEL_CANCELLING_DIAGNOSTIC_TEST") . ' ' . _("ERROR_TIMEOUT") . " (31366)";
        ...
        $errors['start_factoryrestore_timeout']= _("LABEL_RESTORING_FACTORY_DEFAULT") . ' ' . _("ERROR_TIMEOUT") . " (31376)";
        ...
        $errors['get_factoryrestore_timeout'] = _("LABEL_GET_FACTORY_RESTORE_PROGRESS") . ' ' . _("ERROR_TIMEOUT") . " (31386)";
        ...
        */
        ...
        $errors['toggle_connected_device_timeout'] = _("LABEL_BLOCKING_MEDIA_PLAYER") . ' '  . _("ERROR_TIMEOUT") . " (31701)";
        
        $errors['refresh_media_server_list_unk'] = _("LABEL_RESCANNING_MEDIA_PLAYERS") . ' ' . _("ERROR_UNKNOWN") . " (31702)";
        $errors['refresh_media_server_list_timeout']= _("LABEL_RESCANNING_MEDIA_PLAYERS") . ' ' . _("ERROR_TIMEOUT") . " (31703)";
        
        $errors['rescan_dlna_unk'] = _("LABEL_RESCANNING_DLNA_SERVER") . ' '  . _("ERROR_UNKNOWN") . " (31710)";
        $errors['rescan_dlna_timeout'] = _("LABEL_RESCANNING_DLNA_SERVER") . ' '  . _("ERROR_TIMEOUT") . " (31711)";
        
        $errors['rebuild_dlna_unk'] = _("LABEL_REBUILDING_DLNA_SERVER_DATABASE") . ' ' . _("ERROR_UNKNOWN") . " (31712)";
        $errors['rebuild_dlna_timeout'] = _("LABEL_REBUILDING_DLNA_SERVER_DATABASE") . ' ' . _("ERROR_TIMEOUT") . " (31713)";
        
        $errors['get_dlna_status_unk'] = _("LABEL_GET_DLNA_RESCAN_PROGRESS") . ' '  . _("ERROR_UNKNOWN") . " (31714)";
        $errors['get_dlna_status_timeout'] = _("LABEL_GET_DLNA_RESCAN_PROGRESS") . ' '  . _("ERROR_TIMEOUT") . " (31715)";
        
        $errors['enable_dlna_unk'] = _("LABEL_ENABLING_DLNA_SERVICE") . ' '  . _("ERROR_UNKNOWN") . " (31716)";
        $errors['enable_dlna_timeout'] = _("LABEL_ENABLING_DLNA_SERVICE") . ' '  . _("ERROR_TIMEOUT") . " (31717)";
        
        $errors['enable_itunes_unk'] = _("LABEL_ENABLING_ITUNES_SERVICE") . ' '  . _("ERROR_UNKNOWN") . " (31720)";
        $errors['enable_itunes_timeout'] = _("LABEL_ENABLING_ITUNES_SERVICE") . ' '  . _("ERROR_TIMEOUT") . " (31721)";
        
        $errors['rescan_itunes_unk'] = _("LABEL_RESCANNING_ITUNES_SERVER") . ' ' . _("ERROR_UNKNOWN") . " (31722)";
        $errors['rescan_itunes_timeout'] = _("LABEL_RESCANNING_ITUNES_SERVER") . ' ' . _("ERROR_TIMEOUT") . " (31723)";
        
        $errors['toggle_connected_device_unk_error'] = _("LABEL_BLOCKING_MEDIA_PLAYER") . ' '  . _("ERROR_UNKNOWN") . " (31730)";
        $errors['refresh_media_server_list_unk_error'] = _("LABEL_RESCANNING_MEDIA_PLAYERS") . ' ' . _("ERROR_UNKNOWN") . " (31731)";
        $errors['rescan_dlna_unk_error'] = _("LABEL_RESCANNING_DLNA_SERVER") . ' '  . _("ERROR_UNKNOWN") . " (31732)";
        ...
        $errors['rescan_itunes_unk_error'] = _("LABEL_RESCANNING_ITUNES_SERVER") . ' ' . _("ERROR_UNKNOWN") . " (31737)";
        
        $errors['toggle_connected_device_parsererror'] = _("LABEL_BLOCKING_MEDIA_PLAYER") . ' ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (31740)";
        $errors['refresh_media_server_list_parsererror'] = _("LABEL_RESCANNING_MEDIA_PLAYERS") . ' ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (31741)";
        $errors['rescan_dlna_parsererror'] = _("LABEL_RESCANNING_DLNA_SERVER") . ' ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (31742)";
        ...
        $errors['rescan_itunes_parsererror'] = _("LABEL_RESCANNING_ITUNES_SERVER") . ' ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (31747)";
        ...
        $errors['refresh_media_server_list_error'] = _("LABEL_RESCANNING_MEDIA_PLAYERS") . ' ' . _("ERROR_USER_ABORT") . " (31741)";
        $errors['rescan_dlna_error'] = _("LABEL_RESCANNING_DLNA_SERVER") . ' ' . _("ERROR_USER_ABORT") . " (31742)";
        ...
        $errors['rescan_itunes_error'] = _("LABEL_RESCANNING_ITUNES_SERVER") . ' ' . _("ERROR_USER_ABORT") . " (31747)";
        ...
        */ 
        ...
        $errors['ownerPassword'] = _("ERROR_PASSWORD_INCORRECT_SYNTAX");  // . " (32005)";
        $errors['userPassword'] = _("ERROR_PASSWORD_INCORRECT_SYNTAX");  // . " (32006)";
        ...
        $errors['ownerOldPassword'] = _("ERROR_PASSWORD_INCORRECT_SYNTAX");  // . " (32009)";
        ...
        $errors['update_password_timeout'] = _("LABEL_UPDATING_PASSWORD") . ' ' . _("ERROR_TIMEOUT") . " (32056)";
        ...
        $errors['users_get_timeout'] = _("LABEL_GET_USER_INFORMATION") . ' ' . _("ERROR_TIMEOUT") . " (32103)";
        ...
        $errors['users_update_timeout'] = _("LABEL_UPDATING_USER") . ' ' . _("ERROR_TIMEOUT") . " (32123)";
...
//--------------- Generic errors (200,000 + 1, 2, 3,...)
        ...
        $errors['timeout'] = _("ERROR_TIMEOUT") . " (200001)";
...
//--------------- Users error codes (230,000 - 239,999 range)
        // workaround for locale string not yet implemented 
        $username_incorrect_dash_syntax_error = _("ERROR_USERNAME_INCORRECT_SYNTAX_DASH");
        $firstname_incorrect_dash_syntax_error = _("ERROR_ADD_USER_FIRST_NAME_INCORRECT_SYNTAX_DASH");
        ...
        $errors['edit_users_username_form_username_dash'] = $username_incorrect_dash_syntax_error;
        ...
        $errors['create_user_first_name_dash'] = $firstname_incorrect_dash_syntax_error;
        ...
        $errors['getting_started_wizard_add_user_edit_admin_username_dash'] = $firstname_incorrect_dash_syntax_error;  // . " (230013)";
        ...
        $errors['getting_started_wizard_add_user_username_dash'] = $firstname_incorrect_dash_syntax_error; // . " (230017)";
        ...
        $errors['edit_user_password_password'] = _("ERROR_PASSWORD_INCORRECT_SYNTAX");  // . " (230020)";
        $errors['edit_user_password_confirm'] = _("ERROR_PASSWORD_INCORRECT_SYNTAX");  // . " (230021)";
        $errors['edit_user_password_confirm_not_match'] = _("ERROR_PASSWORDS_DONT_MATCH");  // . " (230022)";
...
//--------------- Settings->General errors (310,000 - 319,999 range)
        ...
        $errors['settings_device_name_form_machine_name_dash'] = _("ERROR_ENTER_ALPHANUMERIC_DEVICE_INVALID") . ' ' . _("ERROR_ENTER_ALPHANUMERIC_DEVICE_NAME_DASH"); // . " (3100007)";
        $errors['settings_device_name_form_machine_name_number'] = _("ERROR_ENTER_ALPHANUMERIC_DEVICE_INVALID") . ' ' . _("ERROR_ENTER_ALPHANUMERIC_DEVICE_NAME_NUMBER");  // . " (3100008)";
        $errors['settings_device_name_form_error'] = _("CONTENT_SETTINGS_LABEL_DEVICE_NAME") . ': ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (3100009)";
        $errors['settings_device_description_form_error'] = _("CONTENT_SETTINGS_LABEL_DESCRIPTION") . ': ' . _("ERROR_INTERNAL_SERVER_ERROR") . " (3100009)";
        $errors['factory_restore_progress_form_timeout'] = _("LABEL_GET_FACTORY_RESTORE_PROGRESS") . ' ' . _("ERROR_TIMEOUT") . " (310010)";
        $errors['factory_restore_progress_form_error'] = _("LABEL_GET_FACTORY_RESTORE_PROGRESS") . ' ' . _("ERROR_TIMEOUT") . " (310011)";
...
//--------------- Settings->Network errors (320,000 - 329,999 range)
        ...
        $errors['edit_network_lan_configuration_form_timeout'] = _("ERROR_TIMEOUT_IPADDRESS_CHANGED") . " (320050)";
...
//--------------- Settings->Diagnostics/Utilities errors (340,000 - 349,999 range)
        ...
        $errors['system_factory_restore_timeout'] = _("CONTENT_SETTINGS_LABEL_FACTORY_RESTORE") . ': ' . _("ERROR_TIMEOUT") . " (340002)";
        $errors['put_shutdown_reboot_timeout'] = _("LABEL_REBOOTING_DEVICE") . ' ' . _("ERROR_TIMEOUT") . " (340003)";
        $errors['restore_put_shutdown_reboot_timeout'] = _("CONTENT_SETTINGS_DIALOG_BUTTON_SWITCH_TO_QUICK") . ': ' . _("ERROR_TIMEOUT") . " (340004)";
...
//--------------- Settings->Firmware Update errors (370,000 - 379,999 range)
        ...
        $errors['get_firmware_info_int_error'] = _("LABEL_GET_FIRMWARE_UPDATE_PROGRESS") . ' '  . _("ERROR_INTERNAL_SERVER_ERROR") . " (370014)";
...
//--------------- Error Codes based on error_id from API (400,000 - 409,999 range)
        ...
        */
        ...
        $errors['error_id_127'] = _("ERROR_ID_127");
		...
		$dictionary['InternetAccess'] = _('CONTENT_SETTINGS_NETWORK_STRING_INTERNET_ACCESS');
		$dictionary['InternetAccessTip'] = _("CONTENT_SETTINGS_NETWORK_TOOLTIP_INTERNET_ACCESS");
?>
...
<?php
    ...
    foreach ($dictionary as $key => $message) {
        echo "dictionary[\"".$key."\"] = \"".$message."\";\n";
    }
?>
