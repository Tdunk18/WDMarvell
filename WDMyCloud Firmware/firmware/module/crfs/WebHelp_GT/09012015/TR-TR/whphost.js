	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Birleştirilmiş Yardım sistemi "+aRProj[0].sPPath+" ana Yardım sisteminden farklı bir dil kullanmaktadır, bu da birleştirilmiş Yardım sisteminde dizin ve tüm metin arama işlevini devre dışı bırakır.");
		}
		...
		alert("Düzgün şekilde yüklenemedi, lütfen Yenile butonuna tıklayın.");
}
