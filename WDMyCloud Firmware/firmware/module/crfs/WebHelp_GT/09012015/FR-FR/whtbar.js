...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Masquer le composant de navigation";
	...
	{
		var svTitle="Synchroniser la table des matières";
	...
	{
		var svTitle="Rubrique précédente";
