//	WebHelp 5.10.003
var gsNoTopics="トピックが見つかりませんでした";
var gsLoadXmlFailed="エラー： XMLファイルを読み込めませんでした。";
var gsInitDatabaseFailed="エラー： データベースを初期化できませんでした。";
var gsNotAllDatabaseInited="警告： データベースの一部が読み込まれませんでした。 一のトピックは見つけられません。";
var gsInvalidExpression_1="タイプした語句は、有効な式ではありません。";
var gsInvalidExpression_2="クリック";
var gsInvalidExpression_3="ヘルプ";
var gsInvalidExpression_4="クエリーの式の使い方を学びます。(今後完成)";
var gsSearching="検索中...";
var gsTitle="タイトル";
var gsRank="ランク";
var gsCancel="キャンセル";
...
var gsTotalNumberOfSearchResults = "検索結果の合計数： %1";
