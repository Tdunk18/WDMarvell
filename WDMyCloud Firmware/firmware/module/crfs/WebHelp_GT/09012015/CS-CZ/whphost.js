	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Sloučený systém nápovědy "+aRProj[0].sPPath+" používá odlišný jazyk od hlavního systému nápovědy, což způsobí deaktivaci funkce rejstříku a hledání v textu ve sloučeném systému nápovědy.");
		}
		...
		alert("Nelze načíst správně, klikněte na tlačítko Aktualizovat.");
}
