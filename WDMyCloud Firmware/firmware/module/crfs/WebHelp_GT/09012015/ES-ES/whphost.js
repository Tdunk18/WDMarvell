	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("El sistema de Ayuda fusionado "+aRProj[0].sPPath+" está utilizando un idioma distinto al del sistema de Ayuda principal, por lo que se desactivarán el índice y la función de búsqueda en todo el texto del sistema de Ayuda fusionado.");
		}
		...
		alert("No se ha cargado correctamente. Haga clic en Actualizar");
}
