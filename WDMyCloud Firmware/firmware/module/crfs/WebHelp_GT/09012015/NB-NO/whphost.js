	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Det sammenføyde hjelpesystemet "+aRProj[0].sPPath+" bruker et annet språk fra master-hjelpesystemet, noe som vil gjøre at indeks- og fulltekstsøkefunksjonaliteten i det sammenkoblede hjelpesystemet deaktiveres.");
		}
		...
		alert("Kunne ikke laste korrekt, vennligst klikk på Oppdater.");
}
