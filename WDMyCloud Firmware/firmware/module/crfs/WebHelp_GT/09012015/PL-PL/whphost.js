	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Połączony system pomocy "+aRProj[0].sPPath+" wykorzystuje inny język niż główny system pomocy, co spowoduje wyłączenie indeksu i funkcji wyszukiwania pełnotekstowego w połączonym systemie pomocy.");
		}
