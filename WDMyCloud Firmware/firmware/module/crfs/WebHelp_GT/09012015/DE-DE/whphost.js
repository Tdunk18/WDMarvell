	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Das zusammengeführte Hilfesystem "+aRProj[0].sPPath+" verwendet eine andere Sprache als das Master-Hilfesystem. Deshalb sind die Funktionen für Index und Volltextsuche im zusammengeführten Hilfesystem nicht verfügbar.");
		}
		...
		alert("Konnte nicht korrekt geladen werden, bitte klicken Sie auf Aktualisieren.");
}
