	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Guida combinata "+aRProj[0].sPPath+" sta usando un linguaggio diverso dalla guida in linea principale, che provocherà la disattivazione della funzionalità di indicizzazione e di ricerca full-text nella guida combinata.");
		}
		...
		alert("Impossibile caricare correttamente, fare clic su Aggiorna");
}
