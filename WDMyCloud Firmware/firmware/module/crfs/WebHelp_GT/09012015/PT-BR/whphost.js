	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("O sistema de ajuda mesclado "+aRProj[0].sPPath+" está usando um idioma diferente do sistema de Ajuda mestre, que irá fazer o índice e a funcionalidade de busca de texto completo serem desabilitadas no sistema de Ajuda mesclado.");
		}
		...
		alert("Não foi possível carregar corretamente, clique em Atualizar.");
}
