//	WebHelp 5.10.003
var gsNoTopics="Темы не найдены";
var gsLoadXmlFailed="Ошибка: Не удалось загрузить файл XML.";
var gsInitDatabaseFailed="Ошибка: Не удалось запустить базу данных.";
var gsNotAllDatabaseInited="Предупреждение. Не все базы данных были загружены. Некоторые темы не будут найдены.";
var gsInvalidExpression_1="Вы ввели недопустимое выражение.";
var gsInvalidExpression_2="Нажмите";
var gsInvalidExpression_3="Справка";
var gsInvalidExpression_4="чтобы узнать как пользоваться поисковым синтаксисом (не завершено).";
var gsSearching="Идет поиск…";
var gsTitle="Заголовок";
var gsRank="Рейтинг";
var gsCancel="Отмена";
var gsCanceled="Отменено";
var gsPageDir="ltr";

var gsTotalNumberOfSearchResults = "Всего результатов поиска: %1";
