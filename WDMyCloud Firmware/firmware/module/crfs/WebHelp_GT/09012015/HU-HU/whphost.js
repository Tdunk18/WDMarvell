	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Az egyesített Súgó rendszer "+aRProj[0].sPPath+" a fő Súgó rendszertől eltérő nyelvet használ, ezért az index és teljes szövegre keresés funkciók az egyesített Súgó rendszerben nem fognak működni.");
		}
		...
		alert("Nem sikerült helyesen betölteni, kérjük, kattitnson a Frissítésre.");
}
