...
var gsLoadXmlFailed="错误： 加载 xml 文件失败。";
var gsInitDatabaseFailed="错误： 初始化数据库失败。";
var gsNotAllDatabaseInited="警告： 未加载所有数据库。 一些主题将无法找到。";
var gsInvalidExpression_1="您输入的词条是无效表达式。";
var gsInvalidExpression_2="单击";
var gsInvalidExpression_3="帮助";
var gsInvalidExpression_4="学习怎样使用查询表达式。（待完结）";
