	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Het samengevoegde Helpsysteem "+aRProj[0].sPPath+" gebruikt een andere taal van het master-Helpsysteem, waardoor de index- en volledige-tekstzoekfunctionaliteit is uitgeschakeld in het samengevoegde Helpsysteem.");
		}
		...
		alert("Laden mislukt; klik op Verversen.");
}
