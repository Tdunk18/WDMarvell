	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Det sammanslagna Hjälpsystemet "+aRProj[0].sPPath+" använder ett språk som skiljer sig från Huvudhjälpsystemet, vilket får indexet och sökfunktionen i fulltext att inaktiveras i det sammanslagna Hjälpsystemet.");
		}
		...
		alert("Det gick inte att läsa in på korrekt sätt, klicka på Uppdatera.");
}
