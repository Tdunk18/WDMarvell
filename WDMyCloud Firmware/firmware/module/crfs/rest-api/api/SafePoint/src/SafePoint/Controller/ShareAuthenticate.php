...
/**
 * \file SafePoint/Controller/ShareAuthenticate.php
...
/**
 * \class ShareAuthenticate
 * \brief Authenticate security credentials of a NAS share.
 *
 ...
 */
class ShareAuthenticate /* extends AbstractActionController */ {

    use \Core\RestComponent;
    use SafePointTraitController;

    const COMPONENT_NAME = 'share_authenticate';

    /**
     * \par Description:
     * Authenticate security credentials of a NAS share.
     *
     * \par Security:
     * - Admin LAN request only.
     *
     * \par HTTP Method: POST
     * http://localhost/api/@REST_API_VERSION/rest/share_authenticate
     *
     ...
     *  - name is the name of the safepoint share to auth against
