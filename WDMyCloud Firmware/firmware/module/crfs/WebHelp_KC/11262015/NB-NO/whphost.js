	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Det sammenslåtte hjelpesystemet "+aRProj[0].sPPath+" bruker et annet språk enn hovedhjelpesystemet. Dette innebærer at stikkordregisteret og funksjonen for fulltekstsøk ikke virker som de skal i det sammenslåtte hjelpesystemet.");
		}
		...
		alert("Kan ikke laste på riktig måte, klikk på Oppdater.");
}
