...
#define CONFIG_SERVERIP		192.168.11.114
#else
...
#if 1	//ALPHA_CUSTOMIZE, Casper, 20150616, this modification only for GrandTeton.
#define ENV_ETH_PRIME		"egiga2"
#else
...
#define CONFIG_BOOTARGS                 "root=/dev/ram console=ttyS0,115200"	/* RAMdisk */ 
#else
